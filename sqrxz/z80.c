...
const char* z80RegisterB[] = { "B", "C", "D", "E", "H", "L", "F", "A" };
const char* z80RegisterW[] = { "BC", "DE", "HL", "SP", "AF", "PC", "IX", "IY", "AF2", "BC2", "DE2", "HL2" };
const char* z80RegisterWA[] = { "(BC)", "(DE)" };
int z80DebugPC;
char* z80DebugBufB[8];
char* z80DebugBufW[8];
char* z80DebugBufA[12];
char* z80DebugBufD[12];

char* z80Byte(int n) {
	sprintf(z80DebugBufB, "0%02xh", n);
	return z80DebugBufB;
}

char* z80Word(int n) {
	sprintf(z80DebugBufW, "0%04xh", n);
	return z80DebugBufW;
}

char* z80Address(int n) {
	sprintf(z80DebugBufA, "(0%04xh)", n);
	return z80DebugBufA;
}

char* z80Delta(int n) {
	sprintf(z80DebugBufD, "(Iz+%d)", n);
	return z80DebugBufD;
}

void z80Debug(char *inst, char* p1, char* p2) {
	//fprintf(stdout, "%04x\t %s\t%s %s\n", z80DebugPC, inst, p1, p2);
}
...
{
	z80Debug("LD", z80Address(z80MemReadW(z80Regs[Z80PC])), "SP");
	z80MemWriteW(z80Readword(),z80Regs[Z80SP]);	return 20;
}

int z80LDXYnn()		// LD Iz,nn
{
	z80Debug("LD", "Iz", z80Word(z80MemReadW(z80Regs[Z80PC])));
	*z80Index = z80Readword();	return 4+3+3;
}

int z80LDXYnnm()	// LD Iz,(nn)
{
	z80Debug("LD", "Iz", z80Address(z80MemReadW(z80Regs[Z80PC])));
...
{
	signed char d8;
	z80Debug("LD", z80Delta((signed char)z80MemReadB(z80Regs[Z80PC])), z80Byte(z80MemReadB(z80Regs[Z80PC]+1)));
	d8 = (signed char)z80Readbyte();
...
{
	signed char d8;
	z80Debug("LD", z80Delta((signed char)z80MemReadB(z80Regs[Z80PC])), z80RegisterB[z80Opcode & 7]);
	d8 = (signed char)z80Readbyte();
...
{
	signed char d8;
	z80Debug("LD", z80Delta((signed char)z80MemReadB(z80Regs[Z80PC])), "H");
	d8 = (signed char)z80Readbyte();
...
{
	signed char d8;
	z80Debug("LD", z80Delta((signed char)z80MemReadB(z80Regs[Z80PC])), "L");
	d8 = (signed char)z80Readbyte();
...
{
	z80Debug("LD", z80Address(z80MemReadW(z80Regs[Z80PC])), "XY");
...
{
	signed char d8;
	z80Debug("LD", z80RegisterB[z80Opcode & 7], z80Delta((z80Opcode >> 3) & 7, (signed char)z80MemReadB(z80Regs[Z80PC])));
	d8 = (signed char)z80Readbyte();
...
{
	signed char d8;
	z80Debug("LD", "H", z80Delta((signed char)z80MemReadB(z80Regs[Z80PC])));
	d8 = (signed char)z80Readbyte();
...
{
	signed char d8;
	z80Debug("LD", "L", z80Delta((signed char)z80MemReadB(z80Regs[Z80PC])));
	d8 = (signed char)z80Readbyte();
...
{
	z80Debug("PUSH", z80RegisterW[(z80Opcode >> 4) & 3], "");
...
{
	z80Debug("POP", z80RegisterW[(z80Opcode >> 4) & 3], "");
...
{
	z80Debug("ADD", "A", z80RegisterB[z80Opcode & 7]);
...
{
	signed char d8;
	z80Debug("ADD", "A", z80Delta((signed char)z80MemReadB(z80Regs[Z80PC])));
	d8 = (signed char)z80Readbyte();
...
{
	z80Debug("ADC", "A", z80RegisterB[z80Opcode & 7]);
...
{
	z80Debug("ADC", "A", z80Byte(z80MemReadB(z80Regs[Z80PC])));
	*z80RegsB[Z80A] = z80AdcB(*z80RegsB[Z80A],z80Readbyte());	return 4+3;
}

int z80ADCHLrr()	// ADC HL,rr
{
	z80Debug("ADC", "HL", z80RegisterW[z80Opcode >> 4]);
...
{
	z80Debug("SUB", "A", z80RegisterB[z80Opcode & 7]);
...
{
	z80Debug("SUB", "A", z80Byte(z80MemReadB(z80Regs[Z80PC])));
...
{
	signed char d8;
	z80Debug("SUB", "A", z80Delta((signed char)z80MemReadB(z80Regs[Z80PC])));
	d8 = (signed char)z80Readbyte();
...
{
	z80Debug("SBC", "A", z80RegisterB[z80Opcode & 7]);
...
{
	z80Debug("SBC", "A", z80Byte(z80MemReadB(z80Regs[Z80PC])));
...
{
	signed char d8;
	z80Debug("SBC", "A", z80Delta((signed char)z80MemReadB(z80Regs[Z80PC])));
	d8 = (signed char)z80Readbyte();
...
{
	z80Debug("SBC", "HL", z80RegisterW[z80Opcode >> 4]);
...
{
	z80Debug("AND", "A", z80RegisterB[z80Opcode & 7]);
...
{
	z80Debug("AND", "A", z80Byte(z80MemReadB(z80Regs[Z80PC])));
...
{
	signed char d8;
	z80Debug("AND", "A", z80Delta((signed char)z80MemReadB(z80Regs[Z80PC])));
	d8 = (signed char)z80Readbyte();
...
int z80ORAr()		// OR A,r
{
	z80Debug("OR", "A", z80RegisterB[z80Opcode & 7]);
...
{
	signed char d8;
	z80Debug("OR", "A", z80Delta((signed char)z80MemReadB(z80Regs[Z80PC])));
	d8 = (signed char)z80Readbyte();
...
int z80XORAr()		// XOR A,r
{
	z80Debug("XOR", "A", z80RegisterB[z80Opcode & 7]);
...
{
	z80Debug("XOR", "A", z80Byte(z80MemReadB(z80Regs[Z80PC])));
...
{
	signed char d8;
	z80Debug("XOR", "A", z80Delta((signed char)z80MemReadB(z80Regs[Z80PC])));
	d8 = (signed char)z80Readbyte();
...
int z80CPAr()		// CP A,r
{
	z80Debug("CP", "A", z80RegisterB[z80Opcode & 7]);
...
int z80CPAn()		// CP A,n
{
	z80Debug("CP", "A", z80Byte(z80MemReadB(z80Regs[Z80PC])));
...
{
	signed char d8;
	z80Debug("CP", "A", z80Delta((signed char)z80MemReadB(z80Regs[Z80PC])));
	d8 = (signed char)z80Readbyte();
...
int z80INCr()		// INC r
{
	z80Debug("INC", z80RegisterB[z80Opcode>>3], "");
...
{
	signed char d8;
	z80Debug("INC", z80Delta((signed char)z80MemReadB(z80Regs[Z80PC])), "");
	d8 = (signed char)z80Readbyte();
...
int z80INCrr()		// INC rr
{
	z80Debug("INC", z80RegisterW[z80Opcode >> 4], "");
...
int z80DECr()		// DEC r
{
	z80Debug("DEC", z80RegisterB[z80Opcode >> 3], "");
...
int z80DECrr()		// DEC rr
{
	z80Debug("DEC", z80RegisterW[z80Opcode >> 4], "");
	z80Regs[z80Opcode>>4]-= 1;	return 6;
}
...
{
	signed char d8;
	z80Debug("DEC", z80Delta((signed char)z80MemReadB(z80Regs[Z80PC])), "");
	d8 = (signed char)z80Readbyte();
...
int z80DJNZ()		// DJNZ d8
{
	...
	z80Debug("JNZ", z80Address(z80Regs[Z80PC] + d8), "");
...
int z80RLCr()		// RLC r
{
	z80Debug("RLC", z80RegisterB[z80Opcode&7], "");
...
int z80RLr()		// RL r
{
	z80Debug("RL", z80RegisterB[z80Opcode & 7], "");
...
int z80RRCr()		// RRC r
{
	z80Debug("RRC", z80RegisterB[z80Opcode & 7], "");
...
int z80RRr()		// RR r
{
	z80Debug("RR", z80RegisterB[z80Opcode & 7], "");
...
int z80SLAr()		// SLA r
{
	z80Debug("SLA", z80RegisterB[z80Opcode & 7], "");
...
int z80SRAr()		// SRA r
{
	z80Debug("SRA", z80RegisterB[z80Opcode & 7], "");
...
int z80SLLr()		// SLA r
{
	z80Debug("SLL", z80RegisterB[z80Opcode & 7], "");
...
int z80SRLr()		// SRL r
{
	z80Debug("SRL", z80RegisterB[z80Opcode & 7], "");
...
int z80BITr()		// BIT b,r
{
	z80Debug("BIT", z80Byte((z80Opcode >> 3) & 7), z80RegisterB[z80Opcode & 7]);
...
{
	z80Debug("BIT", z80Byte((z80Opcode >> 3) & 7), "(HL)");
	*z80RegsB[Z80F] = (*z80RegsB[Z80F] & 0xAD) | 0x10;
...
{
	z80Debug("BIT", z80Byte((z80Opcode >> 3) & 7), z80Delta(z80d8));
	*z80RegsB[Z80F] = (*z80RegsB[Z80F] & 0xAD) | 0x10;
...
int z80SETr()		// SET b,r
{
	z80Debug("SET", z80Byte((z80Opcode >> 3) & 7), z80RegisterB[z80Opcode & 7]);
...
{
	z80Debug("SET", z80Byte((z80Opcode >> 3) & 7), "(HL)");
...
{
	z80Debug("SET", z80Byte((z80Opcode >> 3) & 7), z80Delta(z80d8));
...
int z80RESr()		// RES b,r
{
	z80Debug("RES", z80Byte((z80Opcode >> 3) & 7), z80RegisterB[z80Opcode & 7]);
	*z80RegsB[z80Opcode&7] &= ~z80Power[(z80Opcode>>3)&7];
	return 4+4;
}
...
{
	z80Debug("RES", z80Byte((z80Opcode >> 3) & 7), "(HL)");
	z80MemWriteB(z80Regs[Z80HL],z80MemReadB(z80Regs[Z80HL]) & ~z80Power[(z80Opcode>>3)&7]);
	return 4+4+4+3;
}
...
{
	z80Debug("RES", z80Byte((z80Opcode >> 3) & 7), z80Delta(z80d8));
	z80MemWriteB(*z80Index+z80d8,z80MemReadB(*z80Index+z80d8) & ~z80Power[(z80Opcode>>3)&7]);
	return 4+3+5+4+3;
}
...
int z80JP()			// JP nn
{
	z80Debug("JP", z80Address(z80MemReadW(z80Regs[Z80PC])), "");
...
int z80JPcc()		// JP cc,nn
{
	...
	{
	case 0x00:		// NZ
		z80Debug("JP", "NZ", z80Address(d));
		if (*z80RegsB[Z80F]&0x40)		return 4+3+3;
		break;
	case 0x08:		// Z
		z80Debug("JP", "Z", z80Address(d));
		if (!(*z80RegsB[Z80F]&0x40))	return 4+3+3;
		break;
	case 0x10:		// NC
		z80Debug("JP", "NC", z80Address(d));
		if (*z80RegsB[Z80F]&0x01)		return 4+3+3;
		break;
	case 0x18:		// C
		z80Debug("JP", "C", z80Address(d));
		if (!(*z80RegsB[Z80F]&0x01))	return 4+3+3;
		break;
	case 0x20:		// PO
		z80Debug("JP", "PO", z80Address(d));
		if (*z80RegsB[Z80F]&0x04)		return 4+3+3;
		break;
	case 0x28:		// PE
		z80Debug("JP", "PE", z80Address(d));
		if (!(*z80RegsB[Z80F]&0x04))	return 4+3+3;
		break;
	case 0x30:		// P
		z80Debug("JP", "P", z80Address(d));
		if (*z80RegsB[Z80F]&0x80)		return 4+3+3;
		break;
	case 0x38:		// M
		z80Debug("JP", "M", z80Address(d));
		if (!(*z80RegsB[Z80F]&0x80))	return 4+3+3;
		break;
	}
...
int z80JR()			// JR d8
{
	signed char d8 = (signed char)z80Readbyte();
	z80Regs[Z80PC]+= d8;
	z80Debug("JR", z80Address(z80Regs[Z80PC]), "");
	return 4+3+5;
}
...
int z80JRcc()		// JR cc,d8
{
	...
	{
	case 0x00:		// NZ
		z80Debug("JR", "NZ", z80Address(z80Regs[Z80PC] + d8));
		if (*z80RegsB[Z80F]&0x40)		return 4+3;
		break;
	case 0x08:		// Z
		z80Debug("JR", "Z", z80Address(z80Regs[Z80PC] + d8));
		if (!(*z80RegsB[Z80F]&0x40))	return 4+3;
		break;
	case 0x10:		// NC
		z80Debug("JR", "NC", z80Address(z80Regs[Z80PC] + d8));
		if (*z80RegsB[Z80F]&0x01)		return 4+3;
		break;
	case 0x18:		// C
		z80Debug("JR", "C", z80Address(z80Regs[Z80PC] + d8));
		if (!(*z80RegsB[Z80F]&0x01))	return 4+3;
		break;
	}
...
int z80CALLcc()		// CALL cc,nn
{
	...
	{
	case 0x00:		// NZ
		z80Debug("CALL", "NZ", z80Address(d));
		if (*z80RegsB[Z80F]&0x40)		return 4+3+3;
		break;
	case 0x08:		// Z
		z80Debug("CALL", "Z", z80Address(d));
		if (!(*z80RegsB[Z80F]&0x40))	return 4+3+3;
		break;
	case 0x10:		// NC
		z80Debug("CALL", "NC", z80Address(d));
		if (*z80RegsB[Z80F]&0x01)		return 4+3+3;
		break;
	case 0x18:		// C
		z80Debug("CALL", "C", z80Address(d));
		if (!(*z80RegsB[Z80F]&0x01))	return 4+3+3;
		break;
	case 0x20:		// PO
		z80Debug("CALL", "PO", z80Address(d));
		if (*z80RegsB[Z80F]&0x04)		return 4+3+3;
		break;
	case 0x28:		// PE
		z80Debug("CALL", "PE", z80Address(d));
		if (!(*z80RegsB[Z80F]&0x04))	return 4+3+3;
		break;
	case 0x30:		// P
		z80Debug("CALL", "P", z80Address(d));
		if (*z80RegsB[Z80F]&0x80)		return 4+3+3;
		break;
	case 0x38:		// M
		z80Debug("CALL", "M", z80Address(d));
		if (!(*z80RegsB[Z80F]&0x80))	return 4+3+3;
		break;
	}
	z80Regs[Z80SP]-= 2;	z80MemWriteW(z80Regs[Z80SP],z80Regs[Z80PC]);		// push PC
...
int z80RST()		// RST n
{
	z80Debug("RST", z80Byte(z80Opcode & 0x38), "");
	z80Regs[Z80SP]-= 2;	z80MemWriteW(z80Regs[Z80SP],z80Regs[Z80PC]);		// push PC
...
{
	z80Debug("OUT", "(C)", z80RegisterB[(z80Opcode >> 3) & 7]);
...
int z80INrC()		// IN r,(C)
{
	...
	z80Debug("IN", z80RegisterB[(z80Opcode >> 3) & 7], "(C)");
