...
public class CodeSprites
{
  ...
  public static void main(String[] args) throws Exception
  {
    ...
    int line = CodeSprites.doTiles(Toolkit.getDefaultToolkit().createImage("tests/test_all.gif"),imgs);

    PrintWriter pw = new PrintWriter(new FileOutputStream("../sprites.h"));

    pw.println("#define SPRITES_TILES "+imgs.size());
    pw.println("#define SPRITES_LINE "+line);
    pw.println();
    pw.println("const u16 sprites_tiles[SPRITES_TILES*8] = {");
    CodeSprites.saveSprites(imgs,pals,palIdx,pw);
    pw.println("};");
    pw.println();

    pw.println("#define SPRITES_PALS "+pals.size());
    pw.println();
    pw.println("const u16 sprites_pals[SPRITES_PALS*4]= {");
    String s = null;
    ...
    pw.println("const u8 sprites_palidx[SPRITES_TILES] = {");
